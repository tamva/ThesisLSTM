...
dataset = pd.read_csv('/Users/athanasis/Desktop/thesis/PMChineFiveCitie/ShenyangECXELPM20100101_20151231---V2).csv',sep=";", index_col='date', parse_dates=['date'])
# sep=";",
print(dataset.head())

feature_train, label_train, feature_test, label_test = load_data(dataset, 'PM_Taiyuanjie', Enrol_window, True)

dataset["PM_Taiyuanjie"][:'2014'].plot(figsize=(16,4),legend=True)
dataset["PM_Taiyuanjie"]['2014':].plot(figsize=(16,4),legend=True) # 10% is used for thraining data which is approx 2017 data
